...
class CalcStatisticsNode:
    ...
    def process(self, frame_element: FrameElement) -> FrameElement:
        ...
        self.cars_buffer.append(len(frame_element.id_list)) # добавляем текущее число машин в буфер

        info_dictionary = {}
        info_dictionary["cars_amount"] = round(np.mean(self.cars_buffer)) # среднее число машин в кадре
